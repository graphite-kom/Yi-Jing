...
//////////////////////////////////////////////////////////////////////////////
	...
	//////////////////////////////////////////////////////////////////////////
	// START makenice show and hide functions

		function showMakenice(){
			window.document.getElementById('hidden').style.display = 'none';
			window.document.getElementById('shown').style.display = 'block';
		}
	//
		function hideMakenice(){
			window.document.getElementById('shown').style.display = 'none';
			window.document.getElementById('hidden').style.display = 'block';
		}

	// END makenice show and hide functions
	//////////////////////////////////////////////////////////////////////////


	//////////////////////////////////////////////////////////////////////////
	// START comment add show and hide functions

		function showAddComment(){
			window.document.getElementById('titleAddComment').style.display = 'none';
			window.document.getElementById('displayAddComment').style.display = 'block';
		}
	//
		function hideAddComment(){
			window.document.getElementById('displayAddComment').style.display = 'none';
			window.document.getElementById('titleAddComment').style.display = 'block';
		}

	// END comment add show and hide functions
	//////////////////////////////////////////////////////////////////////////
	
		
	//////////////////////////////////////////////////////////////////////////
	// START formOptionChange
	// form Option Change for question/add page
	// 
		//////////////////////////////////////////////////////////////////////
